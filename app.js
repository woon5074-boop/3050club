...
(function () {
'use strict';
var CLUB = { name: '3050파크골프클럽', bank: '새마을금고', account: '03040507777', holder: '3050파크골프(송현호)', band: 'https://www.band.us/band/100365563/post' };
...
function footer() { return '<div class="ft"><span class="b">' + CLUB.name + '</span><span>입금 계좌 ' + acct().bank + ' ' + acct().account + ' (예금주 ' + acct().holder + ')</span><span><a href="' + CLUB.band + '" target="_blank" rel="noopener">네이버 밴드 바로가기</a> · www.3050club.co.kr</span></div>'; }
function sheet(html) {
  closeSheet();
